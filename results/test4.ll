...
for.body:                                         ; preds = %for.cond
  ...
  %add1 = fadd double %conv, 1.000000e-01
  %conv2 = fptrunc double %add1 to float
  store float %conv2, float* %f, align 4
  %3 = load double, double* %d, align 8
  %add3 = fadd double %3, 2.000000e-01
...
for.end:                                          ; preds = %for.cond
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32 %5, i32 %6, double %conv4, double %8)
  ret i32 0
}
